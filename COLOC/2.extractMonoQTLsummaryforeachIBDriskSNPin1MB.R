...
risk_snps <- read.csv("FILEPATH/GRCH38_trait_Delange_RiskSNP.csv", header=TRUE)
risk_snps <- risk_snps %>% 
...
# output directory
outdir <- "FILEPATH/mono_1MB/trait_1MB"
dir.create(outdir, recursive = T)

################################################################################
# sort monocyte eqtl based on geneid
# sort -gk1 monocyte.blueprint.tsv > lu
# mv lu monocyte.blueprint.tsv
